...
//layuiTable参数
    let newTableVar = {
        ...
        , cols: [[
            ...
            , {
                field: 'zhuangTai', width: 100, title: '状态', templet: function (d) {
                    //状态(0待审核,1审核通过,2已修改,完成)
                    let zhuangTaiRes = "";
                    if (d.zhuangTai == 0) {
                        zhuangTaiRes = "<span style='background-color: lightskyblue'>0待审核";
                    } else if (d.zhuangTai == 1) {
                        zhuangTaiRes = "<span style='background-color: lightgoldenrodyellow'>1修改中";
                    } else if (d.zhuangTai == 2) {
                        zhuangTaiRes = "<span style='background-color: rgba(228,144,234,0.53)'>2待复核";
                    } else if (d.zhuangTai == 3) {
                        zhuangTaiRes = "<span style='background-color: lightgreen'>3完成";
                    } else if (d.zhuangTai == 4) {
                        zhuangTaiRes = "<span style='background-color: red;color: white'>审核驳回";
                    } else {
                        zhuangTaiRes = "状态错误";
                    }
                    return zhuangTaiRes;
        ...
        , done: function (res, curr, count) {
            ...
            //$(".layui-table-body").css("height",(document.body.clientHeight)+"px")
