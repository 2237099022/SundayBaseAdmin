layui.use(function () {
    ...
    //定义名称
    let pojoName = 'yyfjhuiyuantianjiacengshu';
    //定义请求路径
    ...
    , {field: 'jiBie',hide:false, title: ''}
    , {field: 'tjNumber',hide:false, title: ''}
    , {field: 'azNumber',hide:false, title: ''}
    , {field: 'zmdNumber',hide:false, title: ''}
    , {field: 'tjid',hide:false, title: ''}
    , {field: 'tj',hide:false, title: ''}
    , {field: 'azid',hide:false, title: ''}
    , {field: 'az',hide:false, title: ''}
    , {field: 'tjCeng',hide:false, title: ''}
    , {field: 'azCeng',hide:false, title: ''}
    ...
    queryData['jiBie'] = mycommon1.kongZiFuZhuanUndefined($('#jiBie').val());
    queryData['tjNumber'] = mycommon1.kongZiFuZhuanUndefined($('#tjNumber').val());
    queryData['azNumber'] = mycommon1.kongZiFuZhuanUndefined($('#azNumber').val());
    queryData['zmdNumber'] = mycommon1.kongZiFuZhuanUndefined($('#zmdNumber').val());
    queryData['tjid'] = mycommon1.kongZiFuZhuanUndefined($('#tjid').val());
    queryData['tj'] = mycommon1.kongZiFuZhuanUndefined($('#tj').val());
    queryData['azid'] = mycommon1.kongZiFuZhuanUndefined($('#azid').val());
    queryData['az'] = mycommon1.kongZiFuZhuanUndefined($('#az').val());
    queryData['tjCeng'] = mycommon1.kongZiFuZhuanUndefined($('#tjCeng').val());
    queryData['azCeng'] = mycommon1.kongZiFuZhuanUndefined($('#azCeng').val());
