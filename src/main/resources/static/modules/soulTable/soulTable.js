    ...
    var tableFilter = layui.tableFilter, tableChild = layui.tableChild, tableMerge = layui.tableMerge, $ = layui.$,
        table = layui.table, HIDE = "layui-hide", tables = {}, originCols = {}, defaultConfig = {
            ...
            render: function (e) {
                ...
                a.filter && a.filter.cache ? (t = location.pathname + location.hash + e.id, i = this.deepStringify(e.cols), originCols[e.id] || (originCols[e.id] = this.deepClone(e.cols), (l = localStorage.getItem(t)) && i === localStorage.getItem("origin" + t) ? this.updateCols(e, this.deepParse(l)) : (localStorage.setItem("origin" + t, i), localStorage.removeItem(t)))) : this.clearCache(e), tableFilter.render(e), tableChild.render(e), tableMerge.render(e), this.suspendConfig[e.id] = {
                    drag: !1,
                    rowDrag: !1
                ...
                for (var o, r, e = {}, t = [], i = [], l = $(a.elem).next().children(".layui-table-box"), d = l.children(".layui-table-fixed").children(".layui-table-header").children("table"), s = $.merge(l.children(".layui-table-header").children("table"), d), c = l.children(".layui-table-header").children("table"), h = l.children(".layui-table-fixed").children(".layui-table-body").children("table"), f = l.children(".layui-table-body").children("table"), u = $.merge(l.children(".layui-table-body").children("table"), h), b = 0; b < a.cols.length; b++) for (o = 0; o < a.cols[b].length; o++) a.cols[b][o].oldPos = b + "-" + o, e[a.cols[b][o].key] = a.cols[b][o];
                for (b = 0; b < n.length; b++) {
                    for (i = [], o = 0; o < n[b].length; o++) {
                        if (r = a.index + "-" + n[b][o].key, n[b][o].width && e[n[b][o].key] !== n[b][o].width && this.getCssRule(a, r, function (e) {
                            e.style.width = (n[b][o].width || 0) + "px"
                        }), e[n[b][o].key].hide !== n[b][o].hide && (s.find('th[data-key="' + r + '"]')[n[b][o].hide ? "addClass" : "removeClass"]("layui-hide"), u.find('td[data-key="' + r + '"]')[n[b][o].hide ? "addClass" : "removeClass"]("layui-hide")), (e[n[b][o].key].oldPos !== b + "-" + o || e[n[b][o].key].fixed !== n[b][o].fixed) && n[b][o].fixed !== e[n[b][o].key].fixed) return a.cols = n, void table.reload(a.id);
                        e[n[b][o].key].fixed = n[b][o].fixed, e[n[b][o].key].width = n[b][o].width, e[n[b][o].key].hide = n[b][o].hide, i.push(e[n[b][o].key])
                    }
                    t.push(i)
                }
                ...
                1 < R.cols.length || (D = this, t = $(R.elem), F = t.next().children(".layui-table-box"), s = $.merge(F.children(".layui-table-header").children("table"), F.children(".layui-table-fixed").children(".layui-table-header").children("table")), _ = F.children(".layui-table-fixed").children(".layui-table-body").children("table"), c = F.children(".layui-table-body").children("table"), O = $.merge(F.children(".layui-table-body").children("table"), _), W = t.next().children(".layui-table-total").children("table"), T = t.next().children(".layui-table-total").children("table.layui-table-total-fixed"), h = t.next().children(".layui-table-total").children("table:eq(0)"), z = R.id, X = "simple" === e || e && "simple" === e.type, E = e && e.toolbar, B = Y = !1, s.attr("drag") || (s.attr("drag", !0), E && (F.append('<div class="soul-drag-bar"><div data-type="left">左固定</div><div data-type="none">不固定</div><div data-type="right">右固定</div></div>'), (N = F.children(".soul-drag-bar")).children("div").on("mouseenter", function () {
                    ...
                    I && (e = I.split("-"), d = R.cols[e[1]][e[2]], k = e[1] + "-" + e[2], C = 0 < w.parents(".layui-table-fixed").length, $(this).find("span:first,.laytable-cell-checkbox").css("cursor", "move").on("mousedown", function (e) {
                        var p, t, y, x, v, m, r, g;
                        D.suspendConfig[z].drag || 0 !== e.button || (e.preventDefault(), p = w.clone().css("visibility", "hidden"), t = w.position().left, y = w.offset().top, x = e.clientX - t, v = w.parents("tr:eq(0)").css("background-color"), m = w.width(), r = $(this), g = d.fixed, B = !0, _DOC.bind("selectstart", function () {
                            return !1
                        }), _BODY.on("mousemove", function (e) {
                            if (B && p) {
                                F.removeClass("no-left-border"), Y || (E && (N.attr("data-type", g || "none"), N.addClass("active")), w.after(p), w.addClass("isDrag").css({
                                    position: "absolute",
                                    "z-index": 1,
                                    "border-left": "1px solid #e6e6e6",
                                    "background-color": v,
                                    width: m + 1
                                }), X || ((C ? _ : O).find('td[data-key="' + I + '"]').each(function () {
                                ...
                                }), 0 < W.length && (C ? T : W).find('td[data-key="' + I + '"]').each(function () {
                                    $(this).after($(this).clone().css("visibility", "hidden").attr("data-clone", "")), $(this).addClass("isDrag").css({
                                        position: "absolute",
                                        "z-index": 1,
                                ...
                                var t, i, l, a, n, o = e.clientX - x, r = p.prev().prev(), d = 0 < r.length,
                                    s = d ? r.data("key").split("-") : [],
                                    c = p.next().hasClass("layui-table-patch") ? [] : p.next(), h = 0 < c.length,
                                    f = h ? c.data("key").split("-") : [], u = d && p.position().left - o > r.width() / 2,
                                    b = h && o - p.position().left > c.width() / 2;
                                if (Math.abs(p.position().left - o), 0 < p.position().left - o ? !d || !!g != !!R.cols[s[1]][s[2]].fixed : !h || !!g != !!R.cols[f[1]][f[2]].fixed) return w.css("left", p.position().left), O.find('td[data-key="' + I + '"][data-clone]').each(function (e) {
                                    $(this).prev().css("left", p.position().left)
                                }), 0 < W.length && W.find('td[data-key="' + I + '"][data-clone]').each(function (e) {
                                    $(this).prev().css("left", p.position().left)
                                }), void F.addClass("no-left-border");
                                if (w.css("left", o), u) {
                                    for (p.after(r), $("#soul-columns" + z + '>li[data-value="' + S + '"]').after($("#soul-columns" + z + '>li[data-value="' + S + '"]').prev()), l = 0; l < R.cols.length; l++) {
                                    ...
                                    for (p.prev().before(c), $("#soul-columns" + z + '>li[data-value="' + S + '"]').before($("#soul-columns" + z + '>li[data-value="' + S + '"]').next()), l = 0; l < R.cols.length; l++) {
                                        for (a = 0; a < R.cols[l].length; a++) if (R.cols[l][a].key === k) {
                                            t = l, i = a;
                                            break
                                        }
                                ...
                                O.find('td[data-key="' + I + '"][data-clone]').each(function () {
                                    $(this).prev().css("left", o), u ? 0 !== $(this).prev().prev().length && $(this).after($(this).prev().prev()) : b && 0 !== $(this).next().length && $(this).prev().before($(this).next())
                                }), 0 < W.length && W.find('td[data-key="' + I + '"][data-clone]').each(function () {
                                    $(this).prev().css("left", o), u ? 0 !== $(this).prev().prev().length && $(this).after($(this).prev().prev()) : b && 0 !== $(this).next().length && $(this).prev().before($(this).next())
                            ...
                            if (_DOC.unbind("selectstart"), _BODY.off("mousemove").off("mouseup"), B && p) {
                                if (B = !1, Y) {
                                    "checkbox" !== d.type && r.on("click", function (e) {
                                        e.stopPropagation()
                                    }), Y = !1, F.removeClass("no-left-border"), w.removeClass("isDrag").css({
                                        position: "relative",
                                        "z-index": "inherit",
                                        left: "inherit",
                                        "border-left": "inherit",
                                    ...
                                    if (g && (e = F.children(".layui-table-header").children("table").find('th[data-key="' + I + '"]'), t ? e.parent().children('th[data-key="' + t + '"]').after(e) : "right" === g ? 0 < w.siblings().length && F.children(".layui-table-header").children("table").find('th[data-key="' + w.next().data("key") + '"]').prev().after(e) : (e.parent().prepend('<th class="layui-hide"></th>'), e.parent().children("th:first").after(e), e.parent().children("th:first").remove())), X ? (O.find('td[data-key="' + I + '"]').each(function () {
                                    ...
                                    }), 0 < W.length && W.find('td[data-key="' + I + '"]').each(function () {
                                        var e;
                                        ...
                                        var e;
                                        t ? $(this).parent().children('td[data-key="' + t + '"]').after($(this)) : "right" === g ? 0 < w.siblings().length && (0 < (e = $(this).parent().children('td[data-key="' + w.next().data("key") + '"]').prev()).length ? e.after($(this)) : ($(this).parent().prepend('<td class="layui-hide"></td>'), $(this).parent().children("td:first").after($(this)), $(this).parent().children("td:first").remove())) : ($(this).parent().prepend('<td class="layui-hide"></td>'), $(this).parent().children("td:first").after($(this)), $(this).parent().children("td:first").remove())
                                    }), _.find('td[data-key="' + I + '"][data-clone]').each(function () {
                                    ...
                                    }), 0 < W.length && (h.find('td[data-key="' + I + '"]').each(function () {
                                        var e;
                                        t ? $(this).parent().children('td[data-key="' + t + '"]').after($(this)) : "right" === g && 0 < (e = $(this).parent().children('td[data-key="' + w.next().data("key") + '"]').prev()).length ? e.after($(this)) : ($(this).parent().prepend('<td class="layui-hide"></td>'), $(this).parent().children("td:first").after($(this)), $(this).parent().children("td:first").remove())
                                ...
                                $("#column-remove").is(":visible") && (s.find("thead>tr>th[data-key=" + I + "]").addClass(HIDE), O.find('tbody>tr>td[data-key="' + I + '"]').addClass(HIDE), W.find('tbody>tr>td[data-key="' + I + '"]').addClass(HIDE), d.hide = !0, D.fixTableRemember(R), $("#soul-columns" + z).find('li[data-value="' + S + '"]>input').prop("checked", !1), tableFilter.resize(R)), $("#column-remove").hide()
                            }
                        }))
                    }))
                })))
            }, rowDrag: function (b, p) {
                var y, e, x = this, v = $(b.elem), m = v.next().children(".layui-table-box"),
                    g = m.children(".layui-table-fixed").children(".layui-table-body").children("table"),
                    k = m.children(".layui-table-body").children("table"),
                    t = $.merge(m.children(".layui-table-body").children("table"), g), C = b.id, w = !1,
                    i = p.trigger || "row", S = !1 !== p.numbers, I = null, R = 0,
                    l = "row" === i ? t.children("tbody").children("tr") : t.find(i);
                for ("row" !== i && t.find(i).css("cursor", "move"), y = 0; y < b.cols.length; y++) for (e = 0; e < b.cols[y].length; e++) if ("numbers" === b.cols[y][e].type) {
                    I = b.index + "-" + y + "-" + e, R = parseInt(k.find('td[data-key="' + I + '"]:first').text());
                    break
                }
                l.on("mousedown", function (e) {
                    ...
                    x.suspendConfig[C].rowDrag || 0 !== e.button || (r = "row" === i ? $(this) : $(this).parents("tr:eq(0)"), d = parseInt(r.data("index")), s = k.children("tbody").children("tr[data-index=" + d + "]"), c = s.clone().css("visibility", "hidden"), h = g.children("tbody").children("tr[data-index=" + d + "]"), f = m.children(".layui-table-body").scrollTop(), t = r.position().top, u = e.clientY - t, _BODY.on("mousemove", function (e) {
                        ...
                        if (_BODY.off("mousemove").off("mouseup"), w) {
                            ...
                            if (i !== d) if ("function" != typeof p.before || !1 !== p.before.call(b, {
                                row: l[d],
                                newIndex: i,
                                oldIndex: d,
                                cache: l
                                ...
                                if (l.splice(i, 0, t), I && S) {
                                    ...
                                    for (y = a[0]; y <= a[1]; y++) {
                                        var n = R + y;
                                        g.find('td[data-key="' + I + '"]:eq(' + y + ")").children().html(n), k.find('td[data-key="' + I + '"]:eq(' + y + ")").children().html(n), l[y][table.config.indexName] = n - 1
                                    }
                                }
                                "function" == typeof p.done && p.done.call(b, {row: t, newIndex: i, oldIndex: d, cache: l})
                            } else {
                                function o(e, t) {
                                    return e.data("index", t), e.attr("data-index", t), e
                                }
                                ...
                                if (i < d) {
                                    for (y = i; y < d; y++) o(k.find('tr[data-index="' + (y + 1) + '"]'), y), o(g.find('tr[data-index="' + (y + 1) + '"]'), y);
                                    o(s, d), k.find('tr[data-index="' + (d - 1) + '"]').after(s), h.each(function () {
                                        o($(this), d), $(this).parent().children('tr[data-index="' + (d - 1) + '"]').after($(this))
                                    })
                                } else {
                                    for (y = i; d < y; y--) o(k.find('tr[data-index="' + (y - 1) + '"]'), y), o(g.find('tr[data-index="' + (y - 1) + '"]'), y);
