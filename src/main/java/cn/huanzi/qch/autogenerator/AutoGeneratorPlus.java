...
public class AutoGeneratorPlus {
    ...
    private String basePackage = "cn\\huanzi\\qch\\mycode\\";//根包位置
    private String filePackage = basePackage + "";//文件所在包位置
...
//        String[] tables = {"yyfj_bian_geng_ming_xi"};
