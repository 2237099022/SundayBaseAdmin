...
public class SqlUtil {
     ...
     * @return sql
     */
    public static StringBuilder joinSqlByEntityAndVo(Class<?> entityClass,Object entityVo,String addWhereSql){
        //select 所有字段 from table
        StringBuilder sql = SqlUtil.appendFields(entityClass);
        ...
        //过滤sql注入并且添加自定义的where 语句
        sql.append(SqlUtil.escapeSql(addWhereSql));
        //拼接排序字段
        SqlUtil.orderByColumn((PageCondition)entityVo,sql);
