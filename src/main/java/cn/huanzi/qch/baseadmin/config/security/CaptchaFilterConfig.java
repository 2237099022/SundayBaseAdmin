    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if(user == null && rememberMeCookie != null){
            ...
            if(flag0 || (flag1 && flag2)){
                ...
                //增加强制下线提示
                //HttpServletResponseUtil.printHtml(response,"<script type='text/javascript'>window.location.href = '" + contextPath + "/logout';"+"window.sessionStorage.setItem('logoutMsg','您已被迫下线，请确认账号密码没有被其他人使用，重新登入方能继续使用系统');</script>");
                return;
            }
